...
class ExactInference(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for position in self.allPositions:            
            oldBelief[position] = self.beliefs[position]*self.getObservationProb(observation, pacman, position, jail)
    ...
    def elapseTime(self, gameState):
        ...
        for key in self.allPositions:            
            newPosDist = self.getPositionDistribution(gameState, key)            
            for pos in newPosDist:
                distribution[pos] += (self.beliefs[key] * newPosDist[pos])
