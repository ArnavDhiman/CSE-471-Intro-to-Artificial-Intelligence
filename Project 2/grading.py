...
class Grades:
    ...
    def __init__(self, projectName, questionsAndMaxesList,
                 gsOutput=False, edxOutput=False, muteOutput=False, hasQ6=False):
        """
...
""")
    ...
    def produceGradeScopeOutput(self):
        ...
        total_possible = sum(self.maxes.values()) + self.q6_max
        total_score = sum(self.points.values()) + self.q6_points
        ...
        """
        Append q6 attr to JSON
        """       
        q6_out = {}
        # test name
        q6_out['name'] = 'q6'
        # test score
        q6_out['score'] = self.q6_points
        q6_out['max_score'] = self.q6_max
        # others
        is_correct = self.q6_points >= self.q6_max
        q6_out['output'] = "  Question 6 ({points}/{max}) {correct}".format(
            points=self.q6_points,
            max=self.q6_max,
            correct=('X' if not is_correct else ''),
        )
        q6_out['tags'] = []
